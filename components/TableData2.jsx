    ...
    <div className={styles.parent}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.imgdiv}>
          ...
          <img src="/images/sample-violation2.jpg" className={styles.image1}/>
          <img src="/images/sample-violation2a.jpg" className={styles.image2}/>
          <img src="/images/sample-violation2b.jpg" className={styles.image3}/>
        </div>
      </div>
    </div>
  )
